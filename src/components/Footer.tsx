  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-2 border-b border-white/40 pb-3">
              <Input type="email" placeholder="Email" className="border-0 px-0" />
              <button aria-label="Submit email" className="text-white/80 hover:text-white">›</button>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative py-20 md:py-24">
          ...
          <div className="pointer-events-none absolute inset-0 z-0 flex items-center justify-center select-none">
            <BrandText className="w-[88vw] max-w-[640px] md:w-[72vw] md:max-w-[980px] lg:max-w-[1120px] opacity-90" />
          </div>
        </div>
      </div>
    </footer>
