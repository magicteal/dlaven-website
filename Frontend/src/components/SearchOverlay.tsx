  ...
  return (
    ...
    >
      ...
      <div
        data-state={state}
        data-search-panel=""
        className="absolute left-4 right-4 top-[82px] sm:top-[92px] md:top-[140px] z-[36] bg-[#F6F4E6] text-[#14161f] [font-family:var(--font-manrope)] backdrop-blur-md shadow-2xl border border-black/10 md:left-6 md:right-6"
      >
        {/* Search field */}
