...
export const metadata: Metadata = {
  title: "Womens Adornments | D' LAVÉN PRIVÉ",
  description: "Exclusive D' LAVÉN Womens Adornments collection — Luxe et Autorité.",
};

const POPPINS = `var(--font-poppins), sans-serif`;
const BG = "#f5f0e8";

export default function PriveWomensAdornmentsPage() {
  return (
